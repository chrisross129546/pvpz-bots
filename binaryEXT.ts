...
declareBinaryType<number>(Binary.UInt8, {
    write: (value: number, bw: IBinaryWriter) => {
        bw.writeUInt8(value)
    },
...
declareBinaryType<string>(Binary.String, {
    write: (value: string, bw: IBinaryWriter) => {
...
declareBinaryType<Uint8Array>(Binary.UInt8Array, {
    write: (value: Uint8Array, bw: IBinaryWriter) => {
        bw.writeUInt8Array(value)
    },
    read: (br: IBinaryReader) => {
        return br.readUInt8Array()
    },
...
declareBinaryType<Int8Array>(Binary.Int8Array, {
    write: (value: Int8Array, bw: IBinaryWriter) => {
        bw.writeInt8Array(value)
    },
    read: (br: IBinaryReader) => {
        return br.readInt8Array()
    },
    byteSize: countByteArray,
    compare: compareTypedArray
})
...
declareBinaryType<Uint16Array>(Binary.UInt16Array, {
    write: (value: Uint16Array, bw: IBinaryWriter) => {
        bw.writeUInt16Array(value)
    },
    read: (br: IBinaryReader) => {
        return br.readUInt16Array()
    },
...
declareBinaryType<Int16Array>(Binary.Int16Array, {
    write: (value: Int16Array, bw: IBinaryWriter) => {
...
declareBinaryType<Uint32Array>(Binary.UInt32Array, {
    write: (value: Uint32Array, bw: IBinaryWriter) => {
        bw.writeUInt32Array(value)
    },
    read: (br: IBinaryReader) => {
        return br.readUInt32Array()
    },
...
declareBinaryType<Int32Array>(Binary.Int32Array, {
    write: (value: Int32Array, bw: IBinaryWriter) => {
...
declareBinaryType<Float32Array>(Binary.Float32Array, {
    write: (value: Float32Array, bw: IBinaryWriter) => {
...
declareBinaryType<Float64Array>(Binary.Float64Array, {
    write: (value: Float64Array, bw: IBinaryWriter) => {
...
declareBinaryType<boolean>(Binary.Boolean, {
    write: (value: any, bw: IBinaryWriter) => {
        bw.writeUInt8(value)
    },
    read: (br: IBinaryReader) => {
        return 1 === br.readUInt8()
    },
    byteSize: () => {
        return 1
    },
...
const binaryGet = function (binaryType: Binary) {
    ...
    if (!b) throw new Error('Unknown binaryType used.')
